...
implementation lanes may run concurrently only in separate isolated worktrees,
with one Worker and sole write ownership per worktree, non-overlapping ownership,
