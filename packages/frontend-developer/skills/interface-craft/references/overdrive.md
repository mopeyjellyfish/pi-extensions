...
**EXTRA IMPORTANT FOR THIS COMMAND**: Context determines what "extraordinary" means. An effect that distracts from a settings task is a failure; instant optimistic saves and clear animated state transitions can be extraordinary. Understand the product task and goals before deciding what is appropriate.
