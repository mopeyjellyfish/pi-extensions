...
Run systematic **technical** quality checks and generate a comprehensive report. Don't fix issues; document them for the applicable follow-on operation.

This is a code-level audit, not a design critique. Check what's measurable and verifiable in the implementation.

## Diagnostic Scan

Use applicable target-owned automated checks across 5 dimensions. Score each dimension 0-4 using the criteria below.
...
**Start here.** Pass/fail: does the implementation express a coherent product-specific system? Cite verified evidence and applicable target-owned automated-check findings.
...
List recommended operations in priority order (P0 first, then P1, then P2):
