...
**CRITICAL**: If no design system exists, do not create one yet. Ask one focused question before proceeding. Understand the preferred location and structure first.
