...
${selectionStyles}@media(prefers-reduced-motion:reduce){.direction{transition:none}.direction:hover{transform:none}.feedback button:active,.close-viewer:active,.view-full-size:active{transform:none}}
